...
describe("MaintenanceAlertService", () => {
  ...
  describe("generateAlerts", () => {
    it("should generate service alert when service is due", async () => {
      // Car is close to needing service (8500 km since last service)
      const car: any = { id: "1", mileage: 98500 }; // Changed from 91500
      const latestService: any = {
        mileage: 90000,
        // 98500 - 90000 = 8500 km since service
        // remaining = 10000 - 8500 = 1500 km (warning!)
      };
      ...
      expect(serviceAlert?.kmRemaining).toBe(1500); // 10000 - 8500 = 1500
    });
