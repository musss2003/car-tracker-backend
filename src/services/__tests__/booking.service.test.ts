...
describe("BookingService", () => {
  ...
  describe("convertToContract", () => {
    ...
    it("should convert confirmed booking to contract", async () => {
      const result = await bookingService.convertToContract(
        "booking-123",
        mockContext,
      );
  ...
  describe("expireBookings", () => {
    ...
    it("should handle errors gracefully", async () => {
      ...
      mockBookingRepo.bulkUpdateStatus.mockRejectedValue(
    ...
    it("should handle findExpiredBookings error gracefully", async () => {
      mockBookingRepo.findExpiredBookings.mockRejectedValue(
  ...
  describe("getByStatus", () => {
    it("should get bookings by status", async () => {
      ...
      expect(mockBookingRepo.findByStatus).toHaveBeenCalledWith(
  ...
  describe("getUpcomingBookings", () => {
    it("should get upcoming bookings", async () => {
      ...
      mockBookingRepo.findUpcomingBookings.mockResolvedValue(
        mockBookings as any,
      );
    ...
    it("should throw ValidationError if days out of range", async () => {
      await expect(bookingService.getUpcomingBookings(0)).rejects.toThrow(
        ValidationError,
      );

      await expect(bookingService.getUpcomingBookings(400)).rejects.toThrow(
        ValidationError,
      );
    });
  });
